...
https://github.com/user-attachments/assets/phalanx-helloworld-demo.mp4

> `/phalanx build "Create a Hello World REST API"` → agents plan, build, test, review → API live in under 2 minutes.
